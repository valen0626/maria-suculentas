              ...
              <div className="product-info">
                ...
                <div className="btns-prod">
                  ...
                  <figure onClick={() => agregarAlCarro(productoItem, 1)}>
                    {carroItems.some((item) =>item.nombre === productoItem.nombre)? <img src="\iconos\bt_added_to_cart.svg" alt="add-to-cart"  /> : <img src="\iconos\bt_add_to_cart.svg" alt="add-to-cart" />}
                  </figure>
                </div>
              </div>
